...
!function($) {
    ...
    DashboardCRM.prototype.init = function() {
        ...
        this.createLineChart('morris-line-chart', $data, 'y', ['a', 'b'], ['Deal-Won ', 'Deal-Lost '],['0.1'],['#ffffff'],['#999999'], ['#191362', '#34d3eb']);
        ...
        this.createBarChart('morris-bar-chart', $barData, 'y', ['a', 'b'], ['Won Deals ', 'Lost Deals '], ['#191362', '#34d3eb']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#ebeff2','#191362', '#34d3eb']);
